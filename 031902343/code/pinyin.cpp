...
{ L"z", L"zhuan", L"×¨…¡ŒŸ×©?Œ£à‹§‰t®U­AÄx´sò§´uÖKî…Ïm÷H×ªŒN¸|ÞD´«ãçžÀßùÜžˆæÉE¬ƒÄR×¬ƒQâÍ×«×­ºeÒN¿xÙ×Nð‚»M‡Ê" },
{ L"z", L"zhun", L"ÍÍÞ„ŒdëÆñ¸×»†”ÕÐq×¼ˆÍƒýœÊ¾MÔR¶›" },
{ L"z", L"zhuo", L"×¾žã×½Ù¾×À—‡—zäÃ—¬ìÌ˜‘?·qßªè@·‡° æšõˆV×ÆŠƒ×¿…¬×Â×Çí½ŸOä·ÚÂQ×ÃŠß×Ä†×Å—Á•Œ”Ù”Ú×Á¬k³˜ÁM·Ÿìú”Û“â“ð„ŸÕŽÕ}ärºW½Éáåª”Þ”½Ö‘ïí™·ùhõîÏ—ž•èCú|»SÐX»m¸B" },
...
{ L"z", L"zu", L"ÜÚ×âÝÏÈ{Éa…a×ã?×ä†XŒœ×å—½¹ŒÛnïßæ—×è×ç×é×æ«~ •ÙÞ†€½MÔ{ì†ü“t" },
...
void build_sensitivepy(int& cnt_c, int& cnt_e, const char* path) {
	...
	int cnt = 0;
	FILE* Sensitive = fopen(path, "r");
	while (fscanf(Sensitive, "%s", str_str) > 0) {
		int lens = strlen(str_str);
		std::wstring_convert<std::codecvt_utf8<wchar_t>> converter;
		wstring s = converter.from_bytes(str_str);
		int len = s.length();
		if (!isHanziChar(s[0]))
		{
			int len = s.length();
			Sentive_Engword[cnt_e].append(s);
			for (int i = 0; i < len; i++) {
				int flag = 0;
				if (s.substr(i, 1) >= L"A" && s.substr(i, 1) <= L"Z") {
					s[i] = tolower(s[i]);
					flag = 1;
				}
				Sensitive_English[cnt_e].append(s.substr(i, 1));
				if (flag == 1) {
					s[i] = toupper(s[i]);
				}
			}
		...
		for (int i = 0; i < len; i++) {
			wstring word = s.substr(i, 1);
			wstring SfirstPy, SfullPy;
			getAllPingyinForWord(word, SfirstPy, SfullPy);
			Sensitive_Word[cnt_c].append(word);
			int len_py = SfullPy.length();
			for (int k = 0, j = 0; k < len_py; k++) {
				if (SfullPy.substr(k, 1) == SfirstPy.substr(j, 1)) {
					Sensitive_Firstpy[cnt_c].append(SfirstPy.substr(j, 1));
					Sensitive_Fullpy[cnt_c].append(SfullPy.substr(k, 1));
					j++;
				}
				else {
					Sensitive_Firstpy[cnt_c].append(SfirstPy.substr(j - 1, 1));
					Sensitive_Fullpy[cnt_c].append(SfullPy.substr(k, 1));
				}
			}
		}
...
void buildArticle_Chinese(char* Article_word)
{
	Article_First.clear();
	Article_Full.clear();
	int lens = strlen(Article_word);
	std::wstring_convert<std::codecvt_utf8<wchar_t>> converter;
	Article_Source_chi = converter.from_bytes(Article_word);
	int len = Article_Source_chi.length();
	for (int i = 0; i < len; i++)
	{
		if (Article_Source_chi[i] >= 0 && Article_Source_chi[i] <= 127)//×Ö·û
		{
			if (isdigit(Article_Source_chi[i]) || isalpha(Article_Source_chi[i]) || Article_Source_chi[i] == '\n')//±£ÁôÆäÖÐÊý×Ö£¬×ÖÄ¸¼°»»ÐÐ·û
			{
				int flag = 0;
				if (Article_Source_chi.substr(i, 1) >= L"A" && Article_Source_chi.substr(i, 1) <= L"Z") {
					Article_Source_chi[i] = tolower(Article_Source_chi[i]);
					flag = 1;
				}
				Article_First.append(Article_Source_chi.substr(i, 1));
				Article_Full.append(Article_Source_chi.substr(i, 1));
				Article_Ndxc.push_back(i);
				if (flag == 1) {
					Article_Source_chi[i] = toupper(Article_Source_chi[i]);
				}
			}
		}
		else if (!isfullp(Article_Source_chi[i]))
		{
			wstring Word = Article_Source_chi.substr(i, 1);
			wstring Word_firstpy, Word_fullpy;
			getAllPingyinForWord(Word, Word_firstpy, Word_fullpy);
			int len_py = Word_fullpy.length();
			for (int k = 0, j = 0; k < len_py; k++) {
				if (Word_fullpy.substr(k, 1) == Word_firstpy.substr(j, 1)) {
					Article_First.append(Word_firstpy.substr(j, 1));
					Article_Full.append(Word_fullpy.substr(k, 1));
					j++;
					Article_Ndxc.push_back(i);
				}
				else {
					Article_First.append(Word_firstpy.substr(j - 1, 1));
					Article_Full.append(Word_fullpy.substr(k, 1));
					Article_Ndxc.push_back(i);
				}
			}
...
void buildArticle_Endlish(char* Article_word)
{
	...
	int lens = strlen(Article_word);
	std::wstring_convert<std::codecvt_utf8<wchar_t>> converter;
	Article_Source_eng = converter.from_bytes(Article_word);
	int len = Article_Source_eng.length();
	for (int i = 0; i < len; i++)
	{
		if (Article_Source_eng[i] >= 0 && Article_Source_eng[i] <= 127)//×Ö·û
		{
			if (isalpha(Article_Source_eng[i]) || Article_Source_eng[i] == '\n')//±£ÁôÆäÖÐ×ÖÄ¸¼°»»ÐÐ·û
			{
				int flag = 0;
				if (Article_Source_eng.substr(i, 1) >= L"A" && Article_Source_eng.substr(i, 1) <= L"Z") {
					Article_Source_eng[i] = tolower(Article_Source_eng[i]);
					flag = 1;
				}
				Article_Eng.append(Article_Source_eng.substr(i, 1));
				Article_Ndxe.push_back(i);
				if (flag == 1) {
					Article_Source_eng[i] = toupper(Article_Source_eng[i]);
				}
			}
		}
		else if (!isfullp(Article_Source_eng[i]))
		{
			wstring Word = Article_Source_eng.substr(i, 1);
			Article_Eng.append(Word);
			Article_Ndxe.push_back(i);
		}
	}
}
...
void getAnswer_chinese(vector<int>& nxt, const int line, const int id, vector<textans>& ans)
{
	int i = 0, j = 0, m = Sensitive_Fullpy[id].length(), n = Article_Full.length();
	int sta = -1;
	while (j < m && i < n)
	{
		if ((Sensitive_Firstpy[id][j] == Article_First[i] && Sensitive_Fullpy[id][j] == Sensitive_Firstpy[id][j] && Article_First[i] == Article_Full[i]) || Sensitive_Fullpy[id][j] == Article_Full[i])
		{
			if (sta == -1) {
				sta = i;
			}
			if (i < n - 1 && j < m - 1 && Sensitive_Fullpy[id][j + 1] == Article_Full[i + 1]) {
				i++;
				j++;
				continue;
			}
			if ((Sensitive_Firstpy[id][j] == Article_First[i] && Sensitive_Fullpy[id][j] == Sensitive_Firstpy[id][j])) {
				int k = j + 1;
				while (Sensitive_Fullpy[id][k] != Sensitive_Firstpy[id][k] && k < m)
					k++;
				if (k >= m - 1) {
					if (i == n - 1 || Article_Full[i + 1] == Article_First[i + 1]) {
						j = m, i++;
					}
					else {
						j = nxt[j - 1];
					...
					if (Sensitive_Fullpy[id][k + 1] == Sensitive_Firstpy[id][k + 1]) {
						k++;
					}
					if (Article_Full[i + 1] == Article_First[i + 1] && Article_Full[i + 1] == Sensitive_Firstpy[id][k]) {
						i++;
						j = k;
					}
					else {
			...
			if (j == m)//ÕÒµ½Ò»¸öÃô¸Ð×Ö
			{
				int l = Article_Ndxc[sta];
				int r = Article_Ndxc[i - 1];
				wstring tmp = L"Line" + to_wstring(line) + L": <" + Sensitive_Word[id] + L"> " + Article_Source_chi.substr(l, r - l + 1);
				ans.push_back({ tmp,line,l });//±£´æ´ð°¸
				j = 0;
				sta = -1;
			}
		}
...
void getAnswer_english(vector<int>& nxt, const int line, const int id, vector<textans>& ans)
{
	int i = 0, j = 0, m = Sensitive_English[id].length(), n = Article_Eng.length();
	while (j < m && i < n)
	{
		if (Sensitive_English[id][j] == Article_Eng[i])
		{
			j++, i++;
			if (j == m)//ÕÒµ½Ò»¸öÃô¸Ð×Ö
			{
				int l = Article_Ndxe[i - m], r = Article_Ndxe[i - 1];
				wstring tmp = L"Line" + to_wstring(line) + L": <" + Sentive_Engword[id] + L"> " + Article_Source_eng.substr(l, r - l + 1);
				ans.push_back({ tmp,line,l });//±£´æ´ð°¸
				j = 0;
			}
		}
...
{
	Article_Ndxc.clear();
	buildArticle_Chinese(Article_word);
	vector<int>nxt;
	for (int k = 0; k < cntc; k++)
	{
		nxt.resize(Sensitive_Fullpy[k].size());
		getNxte(Sensitive_Fullpy[k], nxt);
		getAnswer_chinese(nxt, line, k, ans);
	}
}

void match_english(char* Article_word, const int line, const int cnte, vector<textans>& ans)
{
	Article_Ndxe.clear();
	buildArticle_Endlish(Article_word);
	vector<int>nxt;
	for (int k = 0; k < cnte; k++)
	{
		nxt.resize(Sentive_Engword[k].size());
		getNxte(Sentive_Engword[k], nxt);
		getAnswer_english(nxt, line, k, ans);
	}
}
...
int getAllPingyinForWord(const wstring& inWord, wstring& outFrist_py, wstring& outFull_py)
{
	...
	if (isHanziChar(wch))
	{
		wstring norepeat = getNoRepeatPingyinForWord(inWord);
		if (norepeat != inWord) {
			outFull_py += norepeat;
			wstring firstnorepeat;
			firstnorepeat += norepeat[0];
			outFrist_py += firstnorepeat;
		}
		else {
			for (int index_table = 0; index_table < g_length_hanziTables; index_table++)
			{
				if (hanziTables[index_table].hanzi.find(wch) != -1)
				{
					outFrist_py += hanziTables[index_table].first_py;
					outFull_py += hanziTables[index_table].full_py;
					break;
				}
			}
		}
...
bool isHanziChar(wchar_t wch) {
	...
	return (wch >= 127 && wch <= 65280) ? true : false;
